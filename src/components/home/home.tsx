...
import { getUserData, requestUpdateEmailId, verifyUpdateEmailId } from '../../common/api';
...
export function Home () {
  ...
  const [currentPostHelpingUserName, setCurrentPostHelpingUserName] = useState('');
  ...
  function updateEmail () {
    verifyUpdateEmailId(updatedEmail, OTP)
      .then((_) => {
  ...
  return (
    <>
        ...
        <Link to='/do-post'>
          <div className={styles.right}>
            <div className={styles.para1}>
              <p>
                <img src='assets/home/request-message.png' alt='' height='100px' width='100px' />
              </p>
            </div>
        ...
        <Link to='/find-needy'>
          <div className={styles.left}>
            <div className={styles.para3}>
              <p>
                <img src='assets/home/map.png' alt='' height='100px' width='100px' />
              </p>
            </div>
        ...
        <Link to={'/follow-post?id=' + currentPostHelpingId}>
          <div className={styles.frame}>
            <div className={styles.text}>
              ...
              <p className={styles.textTwo}>posted by {currentPostHelpingUserName}</p>
            </div>
          </div>
        </Link>
      )}
      ...
      <div className={styles.container2}>
        ...
        <div className={styles.line2} data-toggle='modal' data-target='#exampleModalCenter'>
      ...
      <div className={styles.emailImg}>
        <div className={styles.para5}>
          <p>
            <img src='assets/home/email.png' alt='' height='50px' width='50px' />
          </p>
        </div>
      </div>
      <div
        ...
        <div className='modal-dialog modal-dialog-centered' role='document'>
          <div className='modal-content'>
            ...
            <div className='modal-footer'>
              <button className='btn btn-block btn-success' onClick={updateEmail}>
                {' '}
                Update
              </button>
            </div>
