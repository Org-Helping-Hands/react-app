            ...
            <>
                ...
                <div className={`row ${styles.postBox}`}>
                    ...
                    <div className={` col-1 ${styles.iconbox}`}>
                        <span className={`iconify-wrapper `}>
                            <i className={`iconify ${styles.icons}`} data-icon="akar-icons:cross"></i>
                        </span>
                    </div>
                </div>
